...
export const BARCODE_CONFIG = {
  SCAN_TIMEOUT: 120,    // 120ms optimal untuk scanner cepat
  FOCUS_DELAY: 50,
...
export const getCurrentPrice = (item) => {
  ...
  const priceMap = {
    ...
    [SATUAN_TYPES.LUSIN]: item.harga_renteng,
...
export const getSatuanInfo = (item) => {
  ...
  const infoMap = {
    ...
    [SATUAN_TYPES.LUSIN]: item.jumlah_lainnya
  ? `1 lusin = ${item.jumlah_lainnya * 2} pcs`
  : "Harga lusin",
