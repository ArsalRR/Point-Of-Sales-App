...
const LoadingChart = () => (
  <Card className="shadow-sm border-0 bg-gradient-to-br from-slate-50 to-slate-100 lg:col-span-full">
    <CardHeader className="pb-3">
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100">
      <div className="container mx-auto p-6">
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          {/* Card: Total Produk */}
          <Card className="group hover:shadow-lg transition-all duration-300 border-0 bg-gradient-to-br from-white to-blue-50 hover:from-blue-50 hover:to-blue-100">
            <CardHeader className="pb-3">
          ...
          {/* Card: Total Pendapatan Bulanan */}
          <Card className="group hover:shadow-lg transition-all duration-300 border-0 bg-gradient-to-br from-white to-green-50 hover:from-green-50 hover:to-green-100">
            <CardHeader className="pb-3">
              <CardTitle className="flex items-center gap-3 text-gray-700 text-sm font-medium">
          ...
          {/* Card: Stok Sedikit */}
          <Card className="group hover:shadow-lg transition-all duration-300 border-0 bg-gradient-to-br from-white to-amber-50 hover:from-amber-50 hover:to-amber-100">
            <CardHeader className="pb-3">
              <CardTitle className="flex items-center gap-3 text-gray-700 text-sm font-medium">
                ...
                <BarChart data={data.grafik} margin={{ top: 20, right: 30, left: 20, bottom: 20 }}>
                  ...
                  >
                    {data.grafik.map((entry, index) => (
                      <Cell 
                        key={`cell-${index}`} 
                        fill={`hsl(${220 + index * 10}, 80%, ${60 - index * 2}%)`}
                      />
                    ))}
                  </Bar>
                </BarChart>
